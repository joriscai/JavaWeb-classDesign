   ...
   <body>
    ...
    <center>
    	...
    	if(id.equals("first")){
    		...
    		for(int i=0;i<num;i++){
    			if(info[i][6].equals("已借出")){
    				out.print("<tr><td>"+info[i][0]+"</td><td>"+info[i][1]+"</td><td>"+info[i][2]+"</td><td>"+info[i][3]+"</td><td>"+info[i][4]+"</td><td>"+info[i][5]+"</td><td>"+info[i][6]+"</td><td><a href='repay?action=repay&isbn="+info[i][0]+"'>还书</a></td></tr>");
    			}else{
